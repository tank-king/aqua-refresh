...
from src.engine.objects import ObjectManager, BaseObject
...
class Win(Scene):
    ...
    def enter(self):
        BaseObject().post_event(DISPLAY_SUBTITLE, text='Congratulations!', pos=(WIDTH / 2, 100), time='inf')
